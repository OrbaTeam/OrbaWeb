    ...
    >
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          {/* Desktop Action Buttons: Get App + Contact */}
          <div className="hidden md:flex items-center gap-3">
            <a
              href="/orba-mining.apk"
              download="ORBA-Mining-App-v1.0.apk"
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-sm font-medium text-slate-700 hover:text-blue-600 bg-slate-100 hover:bg-slate-200 px-3.5 py-2 rounded-lg transition-colors"
            >
              Contact
          ...
          {/* Mobile Right Controls: "Get App" Direct Download Button + Hamburger Menu Trigger */}
          <div className="flex md:hidden items-center gap-2">
            {/* Mobile "Get App" Action Button */}
            <a
              href="/orba-mining.apk"
              download="ORBA-Mining-App-v1.0.apk"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold text-xs transition-colors shadow-2xs"
            >
        ...
        <div className="md:hidden bg-white/98 backdrop-blur-xl border-b border-slate-200 px-5 pt-4 pb-7 space-y-4 shadow-xl animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
            <a
              href="/orba-mining.apk"
              download="ORBA-Mining-App-v1.0.apk"
              className="flex items-center justify-center gap-2 w-full text-center text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 py-3 rounded-xl shadow-xs active:bg-blue-800 transition-colors"
            >
              <Download className="w-4 h-4" />
              <span>Download Mining App (APK)</span>
            </a>

            <a
              href="#contact"
              onClick={e => scrollToSection(e, '#contact')}
              className="flex items-center justify-center gap-1.5 w-full text-center text-sm font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 py-2.5 rounded-xl transition-colors"
            >
              Get in Touch
          ...
          <div className="pt-4 border-t border-slate-100">
            ...
            <div className="flex items-center justify-center gap-6">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-2 rounded-lg hover:bg-slate-100 transition-colors text-black"
