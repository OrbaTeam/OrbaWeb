      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3.5">
            ...
            <div
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-slate-200/80 border border-slate-300/80 text-slate-500 font-semibold text-sm cursor-not-allowed select-none"
        ...
        {/* Professional App Mockup & Features Card */}
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pb-5 border-b border-slate-100 mb-6">
              ...
              <div>
                <a
                  href="/orba-mining.apk"
                  download="ORBA-Mining-App-v1.0.apk"
                  className="inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 px-3.5 py-1.5 rounded-full border border-emerald-200 transition-colors"
                >
                  <CheckCircle2 className="w-3.5 h-3.5" />
                  Verified APK (Direct Download)
                </a>
              </div>
            </div>
