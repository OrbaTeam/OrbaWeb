        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5 shadow-2xs focus:outline-none focus:ring-2 focus:ring-blue-600/30"
            >
              Learn More
            </button>
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-white hover:bg-slate-50 active:bg-slate-100 text-slate-700 border border-slate-200 font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5 shadow-2xs hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-400/20"
            >
              Get in Touch
            </button>
          </div>
