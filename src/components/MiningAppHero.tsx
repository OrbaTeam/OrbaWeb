      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-3.5">
            {/* Primary Direct Download APK Link from public folder */}
            <a
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pb-5 border-b border-slate-100 mb-6">
              ...
              <div className="flex items-center gap-2">
                <a
                  href="/orba-mining.apk"
                  download="ORBA-Mining-App-v1.0.apk"
                  className="inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 px-3 py-1 rounded-full border border-emerald-200 transition-colors"
                >
