    ...
    <section id="contact" className="py-20 md:py-28 relative z-10 bg-slate-50/70 border-t border-slate-200/60 scroll-mt-16">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Simple Direct Contact Card (MAIL ICON KEPT AS REQUESTED) */}
          <div className="mt-10 p-8 sm:p-12 rounded-2xl bg-white border border-slate-200/90 shadow-2xs">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-md mx-auto">
              <a
                href={`mailto:${email}`}
                className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5 shadow-2xs"
              >
                Send Email
              </a>
              ...
              <button
                type="button"
                onClick={handleCopy}
                className="w-full sm:w-auto inline-flex items-center justify-center px-5 py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5"
              >
