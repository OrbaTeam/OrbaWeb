import { Terminal, Cloud, Layers, FlaskConical } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {focusAreas.map((item, idx) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-200">
